...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-[#fffbfa]/90 shadow-sm backdrop-blur-md">
      <div className="mx-auto flex h-20 items-center justify-between px-6 md:px-12">
        ...
        <button
          className="text-3xl text-[#FF74B1] md:hidden outline-none focus:outline-none select-none"
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="border-t border-gray-100 bg-[#fffbfa] px-6 py-4 shadow-md md:hidden">
          <div className="flex flex-col gap-4 text-lg font-medium text-gray-900">
            ...
            <Link
              href="/login"
              className="mt-2 rounded-xl bg-[#FF74B1] px-5 py-3 text-center text-white font-semibold"
